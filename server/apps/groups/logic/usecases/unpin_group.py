"""Use case for ``DELETE /groups/{id}/pin``."""
...
class UnpinGroupUseCase:
    """Remove the pin of a group for the requesting user. Idempotent."""
    ...
    def __call__(self, user: User, group_id: UUID) -> None:
        ...
        self._group_repo.unpin(user, group)
        log.debug('unpin_group_success', group_id=str(group_id))
